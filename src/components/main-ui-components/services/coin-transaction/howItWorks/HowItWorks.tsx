...
import { Wallet, Send, CheckCircle2, Shield, BarChart3, Clock } from "lucide-react";
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-20">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {[
          {
            icon: <Wallet className="w-10 h-10 text-[#7f00ff]" />,
          ...
          {
            icon: <BarChart3 className="w-10 h-10 text-[#7f00ff]" />,
          ...
          {
            icon: <Send className="w-10 h-10 text-[#7f00ff]" />,
          ...
          {
            icon: <Shield className="w-10 h-10 text-[#7f00ff]" />,
          ...
          {
            icon: <Clock className="w-10 h-10 text-[#7f00ff]" />,
          ...
          {
            icon: <CheckCircle2 className="w-10 h-10 text-[#7f00ff]" />,

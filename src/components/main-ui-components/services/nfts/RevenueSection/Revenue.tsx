...
export default function RevenueSection() {
  ...
  return (
    <section className="py-28 px-6 relative overflow-hidden bg-gradient-to-b from-white via-gray-50 to-white">
      {/* Subtle background glow */}
      <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-[#7f00ff]/5 via-transparent to-blue-400/5 blur-[80px]" />
      ...
      <div className="max-w-6xl mx-auto relative z-10 text-center">
        ...
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-4xl md:text-5xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-[#7f00ff] to-blue-600"
        >
          <span className="main-heading primary-color">Create / Launch / Earn</span>
        </motion.h2>
        ...
        <p className="text-gray-600 max-w-3xl mx-auto mb-20 text-lg leading-relaxed">
          ...
          empowering artists to build, grow, and profit through blockchain innovation.
        </p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, index) => (
            ...
            >
              ...
              <Card className="relative bg-white/90 backdrop-blur-xl border border-gray-100 rounded-3xl hover:shadow-xl transition-all duration-500">
        ...
        <div className="hidden lg:flex justify-between mt-16">
          {[...Array(3)].map((_, i) => (
            <motion.div
              ...
              className="w-20 h-[2px] bg-gradient-to-r from-[#7f00ff]/30 to-transparent rounded-full"
            />
          ))}
        </div>
      </div>

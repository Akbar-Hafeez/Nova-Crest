...
export default function Trust() {
  return (
    ...
    <section className="bg-color max-w-7xl mx-auto px-6 py-16">
      {/* Top Heading */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <svg
            ...
            className="w-14 h-14 text-[#7f00ff] mb-4"
            fill="none"
            viewBox="0 0 24 25"
            strokeWidth={1.8}
            stroke="currentColor"
          ...
          <p className="mt-2 text-color">
            Secure, regulation-ready solutions that keep your business protected at every step.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <h3 className="text-xl font-semibold text-gray-900">Tech at the core</h3>
          <p className="mt-2 text-color">
            Harness the latest in blockchain and digital finance,scalable and always future-ready.
          </p>
        </div>

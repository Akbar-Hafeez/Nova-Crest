...
export default function Web3ConsultancyPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-[#f9f9fb] to-white text-black overflow-hidden">
     ...
     <AboutConsultancy/>
            ...
            {[
              ...
              >
                <div className="flex justify-center mb-6">
                  <div className="p-4 rounded-full bg-gradient-to-r from-[#7f00ff] to-[#00b4ff] text-white">
                    {item.icon}
                  </div>
                </div>
        ...
        <div className="grid md:grid-cols-4 gap-10">
          {[
            ...
            <motion.div
              key={i}
              {...fadeIn(0.2 * i)}
              className="bg-white rounded-3xl border border-[#7f00ff]/10 p-8 shadow-lg hover:shadow-[#7f00ff]/20 transition"
            >
              <div className="flex justify-center mb-4">
                <div className="p-4 bg-gradient-to-r from-[#7f00ff] to-[#00b4ff] rounded-full text-white">
                  {item.icon}
                </div>
              </div>
              <h3 className="text-lg font-semibold text-[#7f00ff] mb-1">
                {item.title}
              </h3>
      ...
      {/* CTA */}
     <CtaBannerUtil heading="Start Your Web3 Journey with Nova " button="Book a Consultation"/>
    </div>
  );
}

    ...
    <section className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-6 text-center">
        <h2 className="text-3xl font-bold mb-12">
          How <span className="text-[#7f00ff]">Nova Trading</span> Works
        </h2>

        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              icon: <FaWallet className="text-4xl text-[#7f00ff]" />,
              title: "Connect Wallet",
              desc: "Securely link your Web3 wallet and get started instantly.",
            },
            {
              icon: <FaChartLine className="text-4xl text-[#7f00ff]" />,
              title: "Execute Trades",
              desc: "Buy, sell, and manage digital assets with real-time analytics.",
            },
            {
              icon: <FaArrowTrendUp className="text-4xl text-[#7f00ff]" />,
              title: "Earn & Grow",
            ...
            >
              <div className="flex items-center justify-center w-16 h-16 rounded-full bg-[#f3e8ff] mb-4">
                {s.icon}
              </div>

    ...
    <div className="bg-white text-black overflow-hidden">
      ...
      <section className="relative py-24 text-center px-6 max-w-6xl mx-auto">
        ...
        <div className="absolute inset-0 flex justify-center items-center">
          <div className="w-[600px] h-[600px] bg-[#7f00ff]/20 blur-[120px] rounded-full" />
        </div>
        ...
        >
          Unleash Creativity with <span className="text-[#7f00ff]">Nova NFTs</span>
        </motion.h1>
...
<section className="py-28 px-6 relative overflow-hidden">
  ...
  <div className="absolute top-0 -right-40 w-[500px] h-[500px] bg-gradient-to-tr from-[#7f00ff]/30 via-pink-400/10 to-blue-400/20 blur-[120px] rounded-full" />
  <div className="absolute bottom-0 -left-40 w-[450px] h-[450px] bg-gradient-to-bl from-blue-400/20 via-[#7f00ff]/20 to-pink-400/10 blur-[120px] rounded-full" />

  <div className="text-center mb-20 relative z-10">
    <h2 className="text-5xl font-bold mb-4 tracking-tight">
      NFT Innovation at <span className="text-[#7f00ff]">Every Step</span>
    </h2>
    <p className="text-gray-600 max-w-3xl mx-auto text-lg">
      From concept to launch, Nova crafts immersive NFT experiences  merging art, technology, and community.
    </p>
  </div>
  ...
  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10 max-w-7xl mx-auto relative z-10">
    {[
      {
        icon: (
          <div className="p-3 rounded-xl bg-gradient-to-tr from-[#7f00ff] via-pink-500 to-blue-400 shadow-lg shadow-[#7f00ff]/30">
      ...
      {
        icon: (
          <div className="p-3 rounded-xl bg-gradient-to-tr from-pink-400 via-[#7f00ff] to-cyan-400 shadow-lg shadow-pink-400/30">
      ...
      {
        icon: (
          <div className="p-3 rounded-xl bg-gradient-to-tr from-cyan-400 via-[#7f00ff] to-pink-400 shadow-lg shadow-cyan-400/30">
      ...
      {
        icon: (
          <div className="p-3 rounded-xl bg-gradient-to-tr from-[#7f00ff] via-blue-400 to-pink-400 shadow-lg shadow-blue-400/30">
      ...
      {
        icon: (
          <div className="p-3 rounded-xl bg-gradient-to-tr from-amber-400 via-pink-400 to-[#7f00ff] shadow-lg shadow-amber-400/30">
      ...
      {
        icon: (
          <div className="p-3 rounded-xl bg-gradient-to-tr from-violet-500 via-[#7f00ff] to-cyan-400 shadow-lg shadow-violet-400/30">
      ...
      <motion.div
        ...
        className="rounded-3xl bg-white/80 backdrop-blur-lg border border-gray-200 shadow-lg hover:shadow-[#7f00ff]/30 transition-all duration-300 p-8"
      >
...
<NFTGallery/>
     ...
     <RevenueSection/>
      ...
      {/* CTA SECTION */}
      <CtaBannerUtil heading=" Ready to Launch Your NFT Collection?" button="Launch With Nova"/>
    </div>
  );
}

...
import FutureOfConnection from "@/components/main-ui-components/services/web3-social-media/futureOfConnection/FutureOfConnection";
...
export default function Web3SocialPage() {
  ...
  return (
    <>
    <div className="relative overflow-hidden bg-gradient-to-b from-white via-gray-50 to-gray-100 text-gray-900">
      {/* Background Glows */}
      <div className="absolute -top-40 -right-40 w-[36rem] h-[36rem] bg-gradient-to-tr from-[#7f00ff]/15 to-blue-400/10 blur-[140px]" />
      <div className="absolute bottom-0 left-0 w-[36rem] h-[36rem] bg-gradient-to-bl from-pink-400/10 to-[#7f00ff]/15 blur-[140px]" />
   ...
   {/* <FutureOfConnection/> */}
      ...
      <section className="py-28 px-6 text-center relative">
        <motion.h2 {...fadeIn()} className="text-4xl font-semibold mb-6">
          How It <span className="text-[#7f00ff]">Works</span>
        </motion.h2>
        <motion.p
          {...fadeIn(0.2)}
          className="text-gray-600 max-w-3xl mx-auto mb-20"
        >
          Every interaction on Nova’s social protocol is powered by decentralized
          smart contracts — ensuring fairness, transparency, and ownership.
        </motion.p>
          ...
          {[
            {
              ...
              gradient: "from-[#7f00ff] to-fuchsia-500",
            },
            {
            ...
            },
            {
              ...
              gradient: "from-cyan-400 to-[#7f00ff]",
            },
          ].map((step, i) => (
            <motion.div key={i} {...fadeIn(0.1 * i)} className="relative group">
              <div
...
<section className="relative py-28 px-6 text-center overflow-hidden">
  ...
  <div className="absolute inset-0 bg-gradient-to-b from-white via-[#f9f5ff] to-gray-50" />
  <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[700px] h-[700px] bg-gradient-radial from-[#7f00ff]/10 via-transparent to-transparent blur-[120px]" />
  ...
  >
    ...
    >
      The <span className="text-[#7f00ff]">Future Layer</span> of Digital Identity
    </motion.h2>
    ...
    >
      Nova blends <span className="text-[#7f00ff] font-medium">AI, Blockchain</span>, 
      and <span className="text-gray-800 font-medium">human creativity</span> — 
      creating an evolving, decentralized identity that adapts to your digital presence.
    </motion.p>
      ...
      {[
        {
          ...
          gradient: "from-[#7f00ff] to-blue-500",
        },
        {
        ...
        },
        {
          ...
          gradient: "from-blue-400 to-[#7f00ff]",
        },
      ].map((item, i) => (
        <motion.div
          key={i}
          {...fadeIn(0.15 * i)}
          className="p-[1px] rounded-2xl bg-gradient-to-br from-[#7f00ff]/20 via-transparent to-transparent hover:from-[#7f00ff]/30 transition-all duration-500"
        >
    ...
    <FaqPage />
      {/* CTA SECTION */}
  <CtaBannerUtil heading="Build The Next Social Revolution" button=" Start With Nova"/>
  </>
  );
}

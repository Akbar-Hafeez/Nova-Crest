...
//   return (
//    <div className="mt-4 md:mt-10 rounded-md bg-gradient-to-r from-[#6626d9] via-[#73c9e3] to-[#6626d9] py-20 px-6">
//       <div className="container mx-auto text-center grid gap-5">
//         <h2 className="main-heading md:mx-10 font-bold text-white mb-6">Powering Trust, Speed, and Stability in Digital Finance</h2>
       
//       <div>  <Button  className="py-3 px-8">
// Experience Nova Crest
//         </Button></div>
//       </div>
//     </div>
//   )
    ...
    <div className="mt-4 md:mt-10 rounded-md bg-gradient-to-r from-[#6626d9] via-[#73c9e3] to-[#6626d9] 
      ...
      <div className="container mx-auto text-center grid gap-1 sm:gap-5">
        <h2 className="text-2xl  md:text-4xl lg:text-5xl font-bold text-white mb-6 leading-snug sm:leading-tight md:leading-tight">
          Powering Trust, Speed, and Stability in Digital Finance
        </h2>

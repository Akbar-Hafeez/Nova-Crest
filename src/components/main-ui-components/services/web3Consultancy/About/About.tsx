...
import {
  ...
  BarChart3,
  Cpu,
} from "lucide-react"; // futuristic icons
  ...
  return (
    <section className="max-w-6xl mx-auto px-6 py-8 grid md:grid-cols-2 gap-16 items-center relative">
      ...
      <motion.div {...fadeIn(0.2)} className="z-10 space-y-8">
        ...
        <div className="space-y-6 mt-8">
          {[
            ...
            >
              <div className="p-3 rounded-xl bg-gradient-to-r from-[#7f00ff] to-[#00b4ff] text-white shadow-md">
                {item.icon}
              </div>
              <div>
      ...
      >
       ...
       <div>
 <Image className="rounded-lg " src={"/web3-consultancy.webp"} alt="web3 Consultancy" width={700} height={400}/>
       </div>
      </motion.div>
    </section>
  );

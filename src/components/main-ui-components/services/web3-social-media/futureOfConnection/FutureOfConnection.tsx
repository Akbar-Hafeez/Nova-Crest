    ...
    <section className="relative py-28 px-6 text-center bg-white text-black overflow-hidden">
      <motion.div {...fadeIn()} className="max-w-6xl mx-auto relative z-10">
        <h2 className="text-4xl md:text-5xl font-bold mb-5 leading-tight">
          The <span className="text-[#7f00ff]">Future</span> of Connection
        </h2>

        <p className="text-gray-600 max-w-3xl mx-auto mb-16 text-lg">
          Web3 social networks empower people through ownership, transparency, and collaboration.  
          Nova transforms every like, share, and post into a digital asset that truly belongs to you.
        </p>
